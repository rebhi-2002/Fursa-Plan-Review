  ...
  return (
    <div className="container py-8 max-w-4xl">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">طلبات التوظيف</h1>
          <p className="text-muted-foreground mt-1">تتبع حالة طلباتك للوظائف المختلفة</p>
        </div>
      </div>
        ...
        {isLoading ? (
              ...
              <CardContent className="p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center">
                      ...
                      تم التقديم: {format(new Date(app.createdAt), 'PPP', { locale })}
                    </div>
                  </div>
                </div>
                <div className="flex flex-row md:flex-col items-center md:items-end justify-between gap-3 shrink-0">
                  ...
                  <Button variant="outline" size="sm" asChild>
                    <Link href={`/jobs/${app.jobId}`}>عرض الوظيفة</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          <Card className="border-dashed bg-muted/20">
            <CardContent className="p-12 text-center flex flex-col items-center">
              ...
              <p className="text-muted-foreground mb-6">لم تقم بالتقديم لأي وظيفة بعد. ابحث عن فرصتك الآن!</p>
